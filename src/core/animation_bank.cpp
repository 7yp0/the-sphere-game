...
void animation_bank_load_player(AnimationBank& bank) {
    Renderer::TextureID idle_tex = Renderer::load_texture("player/player_idle.png");
    ...
    Renderer::TextureID walk0 = Renderer::load_texture("player/player_walk_0.png");
    Renderer::TextureID walk1 = Renderer::load_texture("player/player_walk_1.png");
    Renderer::TextureID walk2 = Renderer::load_texture("player/player_walk_2.png");
