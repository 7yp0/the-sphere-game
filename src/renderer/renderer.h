...
void render_sprite(TextureID tex, Vec2 pos, Vec2 size, Vec4 tex_coord_range, float z_depth = 0.0f);
void render_sprite_animated(const SpriteAnimation* anim, Vec2 pos, Vec2 size, float z_depth = 0.0f);
void render_rect(Vec2 pos, Vec2 size, Vec4 color, float z_depth = 0.0f);
void shutdown();
